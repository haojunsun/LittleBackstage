...
namespace LittleBackstage.Web.Areas.Admin.Controllers
{
    public class ForExcelController : Controller
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult SearchFull(string key, int pageSize, int pageIndex)
        {
            var totalCount = 0;
            ...
            var result = _forExcelService.SearchFull(key, pageIndex, pageSize, ref totalCount);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult SeniorSearch(int state, string key, int pageSize, int pageIndex)
        {
            var totalCount = 0;
            ...
            var result = _forExcelService.SeniorSearch(state, key, pageIndex, pageSize, ref totalCount);
            return Json(result, JsonRequestBehavior.DenyGet);
        }
